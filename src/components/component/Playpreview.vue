<template>
  <div id="playPreview">
      <div class="upInfo">
          ...
          <div class="playControl">
              <div class="trackInfo">
                  ...
                  <p class="trackArtists">{{ trackInfo.al.artists | getArtist(trackInfo.al.artists)}}</p>
              </div>
              <div class="controlItem">
                  <div class="actionWrap">
                        <div class="previous controlButton"></div>
                        <div class="playAndPause controlButton"></div>
      ...
      <div class="playProcess">
          <mu-linear-progress color='red' mode="determinate" :value="30" v-show="isHideProgressBar"></mu-linear-progress>
      </div>
  </div>
</template>
