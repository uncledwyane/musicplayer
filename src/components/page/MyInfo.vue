    ...
    <div id="myInfoWrap">
        <div class="avatarAndInfo">
            ...
            <div class="avatarBanner">
                <img :src="avatarUrl" alt="avatar" class="avatar" /><span
                    class="nickname"
                    >{{ nickname }}</span
                >
                ...
                <div class="other">
                    <mu-button
                        ...
                        color="primary"
                        class="otherInfo"
                        @click="showFollow('follow')"
                        >{{ followCount }}关注</mu-button
                    >
                    <mu-button
                        flat
                        color="secondary"
                        class="otherInfo"
                        @click="showFollow('fans')"
                    >
                        {{ fansCount }}粉丝</mu-button
                    >
                    <mu-button
                        flat
                        color="success"
                        class="otherInfo"
                        @click="showFollow('detail')"
                    >
                        Lv.{{ currlevel }}</mu-button
                    >
                </div>
            </div>
        </div>
        <div class="myPlayList">
            ...
            <ul class="playListCollection">
                <li
                    v-for="collect in playList"
                    :key="collect.id"
                    class="playListCollectionItem"
                    @click="getPlaylist(collect.id)"
                >
                    ...
                    <div class="collecttionInfo">
                        ...
                        <div class="playInfo">
                            <span class="collecttionCount"
                                >{{ collect.trackCount }} 首，</span
                            >
                            <span class="createBy"
                                >by {{ collect.creator.nickname }}，</span
                            >
...
export default {
    ...
    mounted() {
        ...
        if (
            self.followsList == null &&
            sessionStorage.getItem("followsList") == undefined
        ) {
            self.getUserFollows();
        } else {
